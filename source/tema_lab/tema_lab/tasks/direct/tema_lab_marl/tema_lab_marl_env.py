...
from .tema_lab_marl_env_cfg import TemaLabMarlEnvCfg


class TemaLabMarlEnv(DirectMARLEnv):
    cfg: TemaLabMarlEnvCfg

    def __init__(self, cfg: TemaLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
