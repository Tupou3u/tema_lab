...
import tema_lab.tasks.manager_based.locomotion.velocity_rma_v3_ftg.mdp as mdp
...
class ActionsCfg:
    ...
    joint_pos_ftg = mdp.JointPositionFTGActionCfg(
        asset_name="robot", 
        joint_names=[".*"], 
        preserve_order=True,
        f_b=2.0,
