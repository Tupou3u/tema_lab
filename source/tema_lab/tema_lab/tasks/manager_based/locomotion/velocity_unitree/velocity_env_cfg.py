...
import tema_lab.tasks.manager_based.locomotion.velocity_unitree.mdp as mdp
import tema_lab.tasks.manager_based.locomotion.velocity_rma_v3.mdp as rma_mdp
...
class EventCfg:
    ...
    randomize_base_com_position = EventTerm(
        func=mdp.randomize_com_positions,
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="base"),
            "com_distribution_params": ((-0.2, 0.2), (-0.05, 0.05), (-0.05, 0.05)),
            "operation": "add",
        },
    )
    ...
    randomize_com_positions = EventTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=[".*_hip", ".*_thigh", ".*_calf"]),
            "com_distribution_params": ((0.8, 1.2), (0.8, 1.2), (0.8, 1.2)),
            "operation": "scale",
        },
    )
...
class RewardsCfg:
    ...
    foot_clearance = RewTerm(
        func=rma_mdp.foot_clearance_reward,
        weight=0.0,
        params={
            "std": 0.01,
            "tanh_mult": 5.0,
    ...
    action_smoothness = RewTerm(
        func=rma_mdp.ActionSmoothnessPenalty, 
        weight=0.0
    )
    
    base_height = RewTerm(
        func=rma_mdp.base_height_exp,
        weight=0.0,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="base"),
    ...
    stand_still = RewTerm(
        func=rma_mdp.stand_still_penalty,
        weight=0.0,
        params={
            "asset_cfg": SceneEntityCfg("robot"),
        },
    ...
    stand_still_vel = RewTerm(
        func=rma_mdp.stand_still_vel_penalty,
        weight=0.0,
        params={
            "asset_cfg": SceneEntityCfg("robot"),
        },
    ...
    feet_distance_y_exp = RewTerm(
        func=rma_mdp.feet_distance_y_exp2, 
        weight=0.0,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_foot"),
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_foot"),
...
class TerminationsCfg:
    ...
    terrain_out_of_bounds = DoneTerm(
        func=base_mdp.terrain_out_of_bounds,
...
class CurriculumCfg:
    ...
    terrain_levels = CurrTerm(func=base_mdp.terrain_levels_vel)
