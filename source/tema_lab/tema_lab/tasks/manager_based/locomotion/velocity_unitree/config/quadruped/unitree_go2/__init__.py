...
gym.register(
    id="TemaLab-Go2-Velocity-Unitree-Flat-Teacher",
...
gym.register(
    id="TemaLab-Go2-Velocity-Unitree-Rough-Teacher",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="TemaLab-Go2-Velocity-Unitree-Flat-Distillation",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.vel.flat_env_cfg:Go2FlatEnvCfg",
...
gym.register(
    id="TemaLab-Go2-Velocity-Unitree-Rough-Distillation",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.vel.rough_env_cfg:Go2RoughEnvCfg",
...
# gym.register(
#     id="TemaLab-Go2-Velocity_with_orientation-PositionControl-Flat-Teacher-Unitree",
#     entry_point="isaaclab.envs:ManagerBasedRLEnv",
#     disable_env_checker=True,
#     kwargs={
...
# gym.register(
#     id="TemaLab-Go2-Velocity_with_orientation-PositionControl-Rough-Teacher-Unitree",
#     entry_point="isaaclab.envs:ManagerBasedRLEnv",
#     disable_env_checker=True,
#     kwargs={
...
# gym.register(
#     id="TemaLab-Go2-Velocity_with_orientation-PositionControl-Flat-Distillation-Unitree",
#     entry_point="isaaclab.envs:ManagerBasedRLEnv",
#     disable_env_checker=True,
#     kwargs={
#         "env_cfg_entry_point": f"{__name__}.vel_with_pose.flat_env_cfg:Go2FlatEnvCfg",
...
# gym.register(
#     id="TemaLab-Go2-Velocity_with_orientation-PositionControl-Rough-Distillation-Unitree",
#     entry_point="isaaclab.envs:ManagerBasedRLEnv",
#     disable_env_checker=True,
#     kwargs={
#         "env_cfg_entry_point": f"{__name__}.vel_with_pose.rough_env_cfg:Go2RoughEnvCfg",
