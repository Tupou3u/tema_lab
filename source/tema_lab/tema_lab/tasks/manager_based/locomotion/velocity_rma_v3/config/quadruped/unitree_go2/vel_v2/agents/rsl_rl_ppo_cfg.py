...
@configclass
class Go2RoughPPORunnerCfgTeacher(RslRlOnPolicyRunnerCfg):
...
@configclass
class Go2FlatPPORunnerCfgTeacher(Go2RoughPPORunnerCfgTeacher):
...
@configclass
class Go2RoughDistillationRunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 4
    max_iterations = 100_000_000
    save_interval = 500  
    experiment_name = "go2_velocity_rma_v3_rough"
...
@configclass
class Go2FlatDistillationRunnerCfg(Go2RoughDistillationRunnerCfg):
    def __post_init__(self):
        super().__post_init__()
