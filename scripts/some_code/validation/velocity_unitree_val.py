...
from tema_lab.tasks.manager_based.locomotion.velocity_unitree.config.quadruped.unitree_go2.vel.flat_env_cfg import Go2FlatEnvCfg, Go2RoughEnvCfg
...
load_state = torch.load('logs/rsl_rl/go2_velocity_unitree_flat/2025-09-25_11-20-24/model_48500.pt', weights_only=True)['model_state_dict']    
